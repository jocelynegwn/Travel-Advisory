                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" width="160px">
                                ...
                                <a href="<?=site_url('stock/in/del/'.$data->stock_id.'/'.$data->package_id)?>" onclick="return confirm('Apakah anda yakin ingin menghapus data tersebut?')" class="btn btn-danger btn-xs">
